function compareRobots(robot1, robot2) {
    ...
    for(let i=0; i<TURNS; i++) {
        ...
        robot1Turns.push(runRobot(state, robot1));
        robot2Turns.push(runRobot(state, robot2));
    }
    return [robot1Turns.reduce((a,b) => a + b)/TURNS, robot2Turns.reduce((a,b) => a + b)/TURNS];
}
...
const compareTurns = compareRobots(goalOrientedRobot, randomRobot);

console.log(`Der erste Roboter benötigte ${compareTurns[0]} Schritte. Der zweite Roboter hingegen benötigte ${compareTurns[1]} Schritte.`);